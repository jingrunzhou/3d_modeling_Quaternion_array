        ...
        if False:#euler
            if False:#
                if False:
                    ...
                    self.RT = self.evler.R_Rt(self.evler.RT_count_ori(self._T_constant_camera, 0) @ self.evler.RT_count_ori(Tilt, Pan))
                    self.RT_support = self.evler.R_Rt(
                        self.evler.RT_count_ori(self._T_constant_support + self._T_constant_camera, 0) @ self.evler.RT_count_ori(Tilt,Pan))
                # 这两种方法的计算结果大致一样（几乎一样）
            elif False:
