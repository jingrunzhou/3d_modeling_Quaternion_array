...
class Camera_Principles():
    ...
    def init_jr(self):
        ...
        self.K_count()
        self.print_jr('self.flag_calculation_depends,self.d_level, self.installHeight, self.transmissionBelt_Coal_wall1,self._T_constant_camera,self._T_constant_support',
    ...
    def minimize_count(self):
        ...
        guess = np.array([self.d_level, self.installHeight, self.transmissionBelt_Coal_wall1,self._T_constant_camera,self._T_constant_support]).astype(np.float16)
